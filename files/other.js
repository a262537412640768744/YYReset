...
<mo style="font-family: 'YYReset';">生成器</mo>`, 0)}`,
    ...
    ``,
    `
${choose2_("about", "#404040", `<mo style="font-family: 'YYReset';">关于</mo>`, 0)}
${choose2_("achievement", "#404040", `<mo style="font-family: 'YYReset';">成就</mo>`, 1)}
${choose2_("about", "#404040", `<mo style="font-family: 'YYReset';">推荐</mo>`, 2)}`,
  ][choose[0]]
}
...
<table>
  <tbody>
    ...
    <tr>
      <td onmouseover="m = [1, 0]" ${achievement[12] ? `style="background: #ff8000"` : ""}>

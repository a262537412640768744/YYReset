...
const ss = [
  ...
  `<mo style="font-family: 'YYReset';">自动购买</mo>`,
]
const table = [
  [
...
${ss[4]}<mi>y</mi>${ss[5]}`,
  ...
  [
    ...
    `${ss[3]}<mn>3</mn><mi>z</mi>${ss[11]}<mo>    </mo>
${ss[4]}${display_l2n(1, 0)}${ss[12]}${ss[13]}`,
    `${ss[0]}<msubsup><mi>U</mi><mn>0</mn><mn>0</mn></msubsup>${ss[12]}`,
    `${ss[0]}${display_l2n(1, 4)}${ss[1]}`,
    `${ss[14]}<mi>z</mi>${ss[11]}`,
    `${ss[3]}<mn>54</mn><mi>z</mi>${ss[11]}`
  ]
]
...
<math display="block"><msup><mn>2</mn><mn>8</mn></msup></math>`,
  `<math display="block"><mi>z</mi><mo style="font-family: 'YYReset';">星系很好</mo></math>`,
  `<math display="block"><mo style="font-family: 'YYReset';">一副扑克牌</mo></math>`,
]
...
${ykupg[2] ? choose2_("yklng", "#804000", `<mo style="font-family: 'YYReset';">矿产资源</mo>`, 2) : ""}`,
      ``,
      ``,
      ``,
      ``,
...
<math display="block" class="changelog">
  <mn>2025</mn><mo>/</mo><mn>2</mn><mo>/</mo><mn>6</mn>
</math>
<math display="block" class="changelog">
  <mi>v</mi><mi>ω</mi><mo>+</mo><mn>2</mn><mo>:</mo>
  <mo style="font-family: 'YYReset';">添加了矿产资源</mo>
</math>
<math display="block" class="changelog">
  <mn>2025</mn><mo>/</mo><mn>3</mn><mo>/</mo><mn>17</mn>
</math>
<math display="block" class="changelog">
  <mi>v</mi><mi>ω</mi><mo>+</mo><mn>3</mn><mo>:</mo>
  <mo style="font-family: 'YYReset';">完善了矿产资源</mo>
</math>
${ac()}`
}
...
<table>
  <tbody>
    ...
    <tr>
      ...
      ${display_a_achievement(1, 4)}
      ${display_a_achievement(1, 5)}
    </tr>
  </tbody>
</table>`
}
...
function update_achievement(a = true, b = true) {
  if (b) {
    ...
    if (ykupg[4] && (achievement[16] == false)) achievement[16] = time;
    if (ys.ba0 >= 54 && (achievement[17] == false)) achievement[17] = time;
  }
  if (!a) return;
